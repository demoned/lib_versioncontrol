...
public abstract class AVersionService extends Service implements DownloadListener {
    ...
    public static final String PERMISSION_ACTION = "com.bojun.version.file.permission.action";
    ...
    private void verfiyAndDeleteAPK() {
        ...
        try {
            String downloadPath = versionParams.getDownloadAPKPath() + getApplicationContext().getString(R.string.lib_download_apkname, getApplicationContext().getPackageName());

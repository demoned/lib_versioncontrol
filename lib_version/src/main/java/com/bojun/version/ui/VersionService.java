...
import com.bojun.version.builder.BuilderManager;
import com.bojun.version.builder.DownloadBuilder;
import com.bojun.version.builder.VersionCheckBinder;
import com.bojun.version.callback.DownloadListener;
import com.bojun.version.core.DownloadManager;
import com.bojun.version.core.PermissionDialogActivity;
...
import com.bojun.version.net.DownloadMangerV2;
...
//        init();
    ...
    public void onDestroy() {
        ...
        if (builder.isRunOnForegroundService())
            stopForeground(true);
        builder.destory();
        BuilderManager.getInstance().destroy();
        builderHelper = null;
    ...
    private String getDownloadFilePath() {
        return builder.getDownloadAPKPath() + getString(R.string.lib_download_apkname, builder.getApkName() != null ? builder.getApkName() : getPackageName());
    }
    ...
    private void startDownloadApk() {
        ...
        DownloadMangerV2.download(downloadUrl, builder.getDownloadAPKPath(), getString(R.string.lib_download_apkname, builder.getApkName() != null ? builder.getApkName() : getPackageName()), new DownloadListener() {
            @Override

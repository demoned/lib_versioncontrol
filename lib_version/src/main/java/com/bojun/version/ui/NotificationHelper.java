...
import com.bojun.version.builder.NotificationBuilder;
...
public class NotificationHelper {
    ...
    public void showDownloadCompleteNotifcation(File file) {
        ...
        notificationBuilder.setContentText(context.getString(R.string.lib_download_finish));
    ...
    public void showDownloadFailedNotification() {
        ...
        if (versionBuilder.isShowNotification()) {
            ...
            notificationBuilder.setContentIntent(pendingIntent);
            notificationBuilder.setContentText(context.getString(R.string.lib_download_fail));
    ...
    public Notification getServiceNotification() {
        NotificationCompat.Builder notifcationBuilder = new NotificationCompat.Builder(context, channelid)
                .setContentTitle(context.getString(R.string.lib_downloading))
                .setContentText(context.getString(R.string.lib_version_service_runing))
